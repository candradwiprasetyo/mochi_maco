...
include '../models/report_customer_average_model.php';
$page = null;
$page = (isset($_GET['page'])) ? $_GET['page'] : "list";
$title = ucfirst("Report Customer Average");
...
switch ($page) {
	...
	case 'list':
		...
		$action = "report_customer_average.php?page=form_result&preview=1";
		
		include '../views/report_customer_average/form.php';
		...
		if(isset($_GET['preview'])){
            ...
            //include '../views/report_customer_average/form_result.php'; 
			include '../views/report_customer_average/list_item.php';
		}
	...
	case 'form_result':
		...
		header("Location: report_customer_average.php?page=list&preview=1&date=$date_default");
	break;
	...
	case 'form_detail':
		...
		$close_button = "report_customer_average.php?page=form";
			...
			include '../views/report_customer_average/form_save.php';
			include '../views/report_customer_average/list_trainer_view.php';
			include '../views/report_customer_average/list_agent_view.php';
			include '../views/report_customer_average/form_comand3.php';
	...
	case 'download_pdf':
			...
			include '../views/report/report_customer_average_pdf.php';
