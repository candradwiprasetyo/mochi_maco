...
include '../models/report_kepuasan_customer_model.php';
$page = null;
$page = (isset($_GET['page'])) ? $_GET['page'] : "list";
$title = ucfirst("Report Kepuasan Customer");
...
switch ($page) {
	...
	case 'list':
		...
		$action = "report_kepuasan_customer.php?page=form_result&preview=1";
		
		include '../views/report_kepuasan_customer/form.php';
		...
		if(isset($_GET['preview'])){
			...
			$jumlah_customer_puas = get_jumlah_customer_puas($date1, $date2);
			$total_customer = get_total_customer();
			$kepuasan = $jumlah_customer_puas / $total_customer * 100;
			
            include '../views/report_kepuasan_customer/form_result.php'; 
	...
	case 'form_detail':
		...
		$close_button = "report_kepuasan_customer.php?page=form";
			...
			include '../views/report_kepuasan_customer/form_save.php';
			include '../views/report_kepuasan_customer/list_trainer_view.php';
			include '../views/report_kepuasan_customer/list_agent_view.php';
			include '../views/report_kepuasan_customer/form_comand3.php';
	...
	case 'download_pdf':
			...
			include '../views/report/report_kepuasan_customer_pdf.php';
