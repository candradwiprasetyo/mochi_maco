...
include '../models/report_customer_harian_model.php';
$page = null;
$page = (isset($_GET['page'])) ? $_GET['page'] : "list";
$title = ucfirst("Report Customer Harian");
...
switch ($page) {
	...
	case 'list':
		...
		$action = "report_customer_harian.php?page=form_result&preview=1";
		
		include '../views/report_customer_harian/form.php';
		...
		if(isset($_GET['preview'])){
            ...
            //include '../views/report_customer_harian/form_result.php'; 
			include '../views/report_customer_harian/list_item.php';
		}
	...
	case 'form_result':
		...
		header("Location: report_customer_harian.php?page=list&preview=1&date=$date_default");
	break;
	...
	case 'form_detail':
		...
		$close_button = "report_customer_harian.php?page=form";
			...
			include '../views/report_customer_harian/form_save.php';
			include '../views/report_customer_harian/list_trainer_view.php';
			include '../views/report_customer_harian/list_agent_view.php';
			include '../views/report_customer_harian/form_comand3.php';
	...
	case 'download_pdf':
			...
			include '../views/report/report_customer_harian_pdf.php';
