...
include '../models/report_detail_store_model.php';
$page = null;
...
switch ($page) {
	...
	case 'list':
		...
		$action = "report_detail_store.php?page=form_result&preview=1";
		
		include '../views/report_detail_store/form.php';
		...
		if(isset($_GET['preview'])){
           ...
           // include '../views/report_detail_store/form_result.php'; 
			include '../views/report_detail_store/list.php';
			//include '../views/report_detail_store/list_partner.php';
			//include '../views/report_detail_store/list_transaction.php';
		}
	...
	case 'form_result':
		...
		header("Location: report_detail_store.php?page=list&preview=1&date=$date_default");
	break;
	...
	case 'form_detail':
		...
		$close_button = "report_detail_store.php?page=form";
			...
			include '../views/report_detail_store/form_save.php';
			include '../views/report_detail_store/list_trainer_view.php';
			include '../views/report_detail_store/list_agent_view.php';
			include '../views/report_detail_store/form_comand3.php';
	...
	case 'download_pdf':
			...
			include '../views/report/report_detail_store_pdf.php';
	...
	break;
        ...
        case 'download_tagihan':
			...
			$title = 'report_detail_store_tagihan';
			$supplier_title = str_replace(" ","_", $supplier);
			$format = create_report($title."_".$supplier_title."_".$i_date);
			
			include '../views/report/report_detail_store_tagihan.php';
