                            ...
                            <div class="box box-cokelat">
                                ...
                                <div class="box-body">
                                        ...
                                        <div class="col-md-6">
                                      	<div class="form-group">
                                            <label>Debit</label>
                                            <input required type="text" name="i_journal_debit" class="form-control" placeholder="" value="<?= $row->journal_debit ?>"/>
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                      	<div class="form-group">
                                            <label>Credit</label>
                                            <input required type="text" name="i_journal_credit" class="form-control" placeholder="" value="<?= $row->journal_credit ?>"/>
                                        </div>
                                        </div>
                                         ...
                                         <div class="col-md-6">
                                      	<div class="form-group">
                                            <label>Piutang</label>
                                            <input required type="text" name="i_journal_piutang" class="form-control" placeholder="" value="<?= $row->journal_piutang ?>"/>
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                      	<div class="form-group">
                                            <label>Hutang</label>
                                            <input required type="text" name="i_journal_hutang" class="form-control" placeholder="" value="<?= $row->journal_hutang ?>"/>
                                        </div>
                                        </div>
