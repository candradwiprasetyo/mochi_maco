                                      ...
                                      <table id="" class="" width="100%">
                                        <tbody>
                                         ...
                                         <tfoot>
                                            ...
                                            <tr>
                                            <td colspan="3" style="text-align:right; " >
                                                 <input required type="text" name="i_ppn" id="i_ppn" class="form-control" value="<?= ($ppn)?>" style="text-align:right; font-size:20px;" readonly/>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                               ...
                                               $total_price3 = $total_price2 + $ppn;
                                               ?>
                                            </tr>
                                            <tr>
                                            <td colspan="3" style="text-align:right; " >
                                                 <input required type="text" name="i_grand_total" id="i_grand_total" class="form-control" value="<?= ($total_price3)?>" style="text-align:right; font-size:20px;" readonly/>
                                                </td>
                                            </tr>
                                    ...
                                    <div class="col-md-12" style="padding:0px;">
                                      <div class="payment_group">
                                        ...
                                        <b>Nominal</b>
                                         ...
                                         <input required type="text" name="i_payment" id="i_payment" class="form-control calc_nominal" value="<?= ($total_price3) ?>" style="text-align:right; font-size:20px;" onChange="update_change()"/>
 ...
 <!-- page script -->
    ...
    function update_discount(){
	   ...
	   document.getElementById("i_discount").value = discount;
        ...
        var ppn = 10/100*grand_total;
        //alert(grand_total);
        grand_total = grand_total + ppn;

        document.getElementById("i_ppn").value = ppn;
