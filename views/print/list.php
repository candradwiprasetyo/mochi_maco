...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:14px;">
  ...
  <tr>
    ...
    $pajak = 10 / 100 * $row['transaction_grand_total'];
    echo number_format($pajak)?></strong></td>
  </tr>
  <tr>
    <td><strong>Grand Total</strong></td>
    <td align="right"><strong><?php
    $row['transaction_grand_total'] = $row['transaction_grand_total'] + $pajak;
    echo number_format($row['transaction_grand_total'])?></strong></td>
  </tr>
  <tr>
