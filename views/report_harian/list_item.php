...
<h3 class="box-title"><strong>Transaksi</strong></h3>
</div>
                        ...
                        $total_harga_pajak = 0;
                                            ...
                                            <td><?= $no_item ?></td>
                                              ...
                                              ?>
                                                ...
                                                <td>
                                                                      <?php
                                              $total_grand_total = get_total_grand_total($date_awal);
                                              $total_grand_total = ($total_grand_total) ? $total_grand_total : 0;
                                              echo tool_format_number($total_grand_total);
                                              ?>
                                                </td>
                        ...
                        $total_harga_pajak = $total_harga_pajak + $total_pajak;
											...
											<tr>
                                             ...
                                             <td><?= tool_format_number_report($total_grand_total)?></td>
                                              </tr>
                                          </tfoot>
